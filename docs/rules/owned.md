...
As stated in the [definition](#definition), owned objects **SHOULD NOT** be treated as default/regular Minecraft objects, but **SHOULD** still be recognized as objects of their type.
